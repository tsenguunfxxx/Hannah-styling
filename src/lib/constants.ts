 ...
 * тооцоолол хялбар.
 *
 * ⬇️ ОДООГООР ТҮР ҮНЭГҮЙ (0). Эргүүлж асаах бол доорх тоог
 *    10000 болгоход л хангалттай — өөр газар засах шаардлагагүй.
 *    0 үед сагс, checkout хоёул "Үнэгүй" гэж харуулна.
 */
