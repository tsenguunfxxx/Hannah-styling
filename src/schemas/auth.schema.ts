...
/**
 * Нэвтрэх — УТАС эсвэл ИМЭЙЛ хоёрын аль нэгээр.
 *
 * Хоёр талбар тусад нь биш, нэг `identifier` талбар ашигласан.
 * Ингэснээр хэрэглэгч аль хэлбэрээр бичсэнийг серверт таньж болно:
 *   "@" агуулж байвал имэйл, үгүй бол утас.
 */
